...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2023 a las 01:36:51
...
ALTER TABLE `users`
  ...
  ADD KEY `users_usuario_id_foreign` (`usuario_id`);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_usuario_id_foreign` FOREIGN KEY (`usuario_id`) REFERENCES `type_user` (`id`) ON DELETE CASCADE;
COMMIT;
